...
int main(int argc, char* argv[])
{
    ...
    f->keypress('r');
    assert_eq(0, f->z80_info().pc);
    assert_eq(1, f->z80_step().pc);
    assert_eq(3, f->z80_step().pc);
    assert_eq(6, f->z80_step().pc);
    assert_eq(7, f->z80_step().pc);
    ...
    assert_eq("Check that SDCard write was successful", true,
    ...
    assert_eq("Check that SDCard read was successful", true,
              std::equal(written.begin(), written.end(), expected.begin()));
}
